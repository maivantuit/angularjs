...
<body ng-app="myApp">
	...
	ng-change:	Specifies an expression to evaluate when content is being changed by the user.(Dua con tro ra)
	...
	ng-cloak:	Ngăn chặn nhấp nháy khi ứng dụng của bạn đang được tải.
	...
	ng-focus:	Specifies a behavior on focus events.(Dua con tro vao)
